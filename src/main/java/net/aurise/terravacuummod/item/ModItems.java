...
public class ModItems {
    ...
    public static final Item TERRAVACUUM = registerItem("terravacuum", new TerravacuumItem(new Item.Settings().registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(TerravacuumMod.MOD_ID,"terravacuum"))).maxDamage(100)));
